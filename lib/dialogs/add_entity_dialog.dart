...
class AddEntityDialog<E, O> extends AbstractDialog {
  static Future openAddArtistDialog(BuildContext context, {Tag preselectedTag}) async {
    final dialog = preselectedTag != null
        ? new AddEntityDialog<Artist, Tag>.withPreselectedOtherEntity(context, preselectedTag)
        : new AddEntityDialog<Artist, Tag>(context);
    return await dialog.show();
  }

  static Future openAddTagDialog(BuildContext context, {Artist preselectedArtist}) async {
    final dialog = preselectedArtist != null
        ? new AddEntityDialog<Tag, Artist>.withPreselectedOtherEntity(context, preselectedArtist)
  ...
  StatelessWidget buildDialog(BuildContext context) {
    return SimpleTextInputDialogBase(
        ...
        onSendInput: (String newInput) => _addEntity(context, newInput, preselectedOtherEntity));
  }
